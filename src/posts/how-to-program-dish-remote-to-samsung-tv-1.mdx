...
beforebody: >-
  ...
  * Select your TV brand (Samsung). 
  ...
  ![Dish battery level](/img/reciver-remote-battery-level.png "Dish battery percentage")
  ...
  ![Dish setting](/img/reciver-menu.png "Dish setting menu")
  ...
  ![dish remote control](/img/reciver-remote-control-option.png "dish remote control menu")
  ...
  ![dish remote sitting](/img/dish-remote-control-setting.png "dish remote to tv")
  ...
  ![try next code universal dish remote](/img/try-next-code.png "try next code universal dish remote")
table:
  table: false
products: []
afterbody: ""
